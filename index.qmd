...
![](images/qrcode_github_repo.svg){.absolute top=0 right=0 width=300}

- The presentation and demo notebooks\
  are publicly available at [GitHub](github.com/BerndDoser/SPACE_HPC_Visualization_Workshop) (QR code $\rightarrow$)
...
contains over **200 billion** blue (BP) and red (RP) spectra as continuous spectra with 55 parameters per spectrum.
